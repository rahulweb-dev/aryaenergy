...
export const Route = createFileRoute("/locations")({
  head: () => ({
    meta: [
      { title: "Locations — ATS India" },
      { name: "description", content: "Automated testing stations across Delhi NCR, Mumbai, Bengaluru and Hyderabad." },
      { property: "og:title", content: "Locations — ATS India" },
