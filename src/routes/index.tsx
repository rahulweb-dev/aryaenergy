...
import { FadeIn, Stagger, StaggerItem, staggerItemVariants, Counter } from "@/components/site/motion";
import {
...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Book a fully automated, VAHAN-integrated vehicle fitness test. 10-minute testing, government-approved, transparent results." },
          ...
          <FadeIn delay={0.25}>
            <div className="mt-8 flex flex-wrap gap-3">
              <Button asChild size="lg" className="gradient-brand text-brand-foreground shadow-elevated hover:opacity-95">
                <Link to="/book">Book Vehicle Test <ArrowRight className="ml-1 h-4 w-4" /></Link>
              </Button>
              <Button asChild size="lg" variant="outline">
                <Link to="/process"><PlayCircle className="mr-1 h-4 w-4" /> Learn More</Link>
              </Button>
            </div>
          </FadeIn>
          <FadeIn delay={0.35}>
