...
export const Route = createFileRoute("/process")({
  head: () => ({
    meta: [
      { title: "Testing Process — ATS India" },
      { name: "description", content: "See how a vehicle moves from gate to certificate in under 15 minutes." },
      { property: "og:title", content: "Testing Process — ATS India" },
