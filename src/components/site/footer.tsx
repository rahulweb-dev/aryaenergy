    ...
    <footer className="mt-24 border-t border-border bg-secondary text-secondary-foreground">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 md:grid-cols-4 md:px-6">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/80">
            ...
            <li><Link to="/process" className="hover:text-white">Testing Process</Link></li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/80">
            ...
            <li><Link to="/track" className="hover:text-white">Track Vehicle</Link></li>
            <li><Link to="/certificate" className="hover:text-white">Download Certificate</Link></li>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-2 px-4 py-5 text-xs text-white/60 md:flex-row md:px-6">
          ...
          <div>MoRTH Accredited · VAHAN Integrated · ISO 9001:2015</div>
        </div>
      </div>
    </footer>
  );
